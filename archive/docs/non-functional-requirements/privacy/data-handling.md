...
Microsoft runs on trust. Our customers trust ESF Engineering to adhere to the highest standards when handling their data.
...
Developers working on ESF Engineering projects should implement best practices and guidance on handling data throughout the project phases. This page is not meant to suggest how customers should handle data in their environment. **It does not override**:
...
## Handling Data in ESF Engineering Engagements
...
Developers working on ESF Engineering projects will work with our customers to define the data needed for each engagement.

If there is a need to access production data,
ESF Engineering needs to review the need with their lead and work with the customer to put audits in place verifying what data was accessed.
...
Customers should provide ESF Engineering with a copy of the requested data in a location managed by the customer.
...
ESF Engineering should notify the customer when they are done with the data and suggest the customer destroy copies of the data if they are no longer needed.
