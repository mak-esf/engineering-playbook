...
- Engineering team should follow the same rigor in building ML projects as in any software engineering project. We at ESF Engineering (eSolutions First Engineering) have built a good set of resources from our learnings in our [ESF Engineering Engineering Playbook](../README.md).
