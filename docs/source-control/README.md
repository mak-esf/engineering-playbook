...
* Following industry best practice to work in geo-distributed teams which encourage contributions from all across [ESF Engineering](../ESF-engineering.md) as well as the broader OSS community
...
* [ESF Engineering Git details](git-guidance/README.md)details on how to use Git as part of a [ESF Engineering](../ESF-engineering.md) project.
