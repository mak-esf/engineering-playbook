...
You can use templates like working agreements and such from the [ESF Engineering Playbook](https://github.com/esf/engineering-playbook/).
...
```markdown
# ESF Engineering Documentation

This is the landing page of the ESF Engineering Documentation website. This is the page to introduce everything on the website.
